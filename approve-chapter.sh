...
echo "  ─────────────────────────────────────────────"
echo "  💡 Next steps:"
echo "     1. Extract products: 'extract products $CHAPTER_FILE'"
echo "        → Generates Etsy listings, Gumroad pages, course outlines"
echo "     2. Write next chapter or run full manuscript extraction when done"
echo "  ─────────────────────────────────────────────"
echo ""
