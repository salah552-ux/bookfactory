...
**S.A. Ibrahim** (consistent across all series titles; no clinical credentials claimed — per series rule).

---

## 5. DESCRIPTION (KDP HTML — leads with the fear hook)
...
<p><b>Here is the truth no scare-headline tells you: most people who carry H. pylori never get cancer. The risk is real enough to treat. It is low enough not to panic. Both of those things are true at once, and this book holds them both.</b></p>

<p><i>The H. Pylori Recovery Plan</i> is the evidence-grounded guide for the person who wants to actually clear this infection, heal the damage it left behind, and understand their cancer risk in proportion. It does not sell you a tea. It does not promise a "natural cure in 60 days." It explains the mechanism, cites the research by name, and lets you decide.</p>
...
<li>What to do <b>when antibiotics fail</b> the first time, the second time, even the fifth time: the rescue therapies (rifabutin-based, furazolidone) almost no consumer book explains</li>
<li>Why roughly one in four treatments fail even when the bacteria are not resistant, and the adherence and timing mistakes that quietly sabotage eradication</li>
...
<li>The adjuncts that the 2024-2025 evidence actually supports (mastic gum, broccoli-sprout sulforaphane, Lactobacillus reuteri) framed honestly as helpers alongside treatment, never instead of it</li>
<li>The cancer question, answered with the real numbers from the 2025 IARC and Nature Medicine research, so you can stop spiralling and start acting</li>
...
## 6. SEVEN BACKEND KEYWORDS (byte-verified ≤50, ASCII, no title/subtitle duplication)
...
Byte counts (verified): 31, 27, 32, 34, 28, 28, 27 — all ≤50. Intent flags and rationale in SEO-STRATEGY.md §5b–5c. Row 7 is the only post-launch swap-watch candidate.
...
## 9. AI CONTENT DISCLOSURE (mandatory at upload — ALGO §16)

Three fields, per series-consistent answers:
- **Interior text — AI-generated?** Yes (AI-generated text reviewed and edited by the human publisher; every statistic verified against a named source).
- **Cover image — AI-generated?** Yes (AI-generated image, human-reviewed) — confirm against final cover asset at production.
- **Translation — AI-generated/assisted?** No.
