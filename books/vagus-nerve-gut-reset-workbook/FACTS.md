...
| Stat | Value | Source |
|------|-------|--------|
| Vagus nerve = cranial nerve | Tenth (X), longest cranial nerve | Berthoud & Neuhuber 2000 |
| Vagal fibre split | ~80% afferent (gut→brain), ~20% efferent | Agostoni 1957; Berthoud & Neuhuber 2000 |
| Enteric neurons | 200–600 million | Furness 2012 |
| Optimal vagal-toning breath rate | ~5–6 breaths/min | Lehrer & Gevirtz 2014; Russo 2017 |
| Physiological sigh | Double inhale + long exhale; beat mindfulness in RCT for mood/arousal | Balban 2023 |
| Humming + nasal nitric oxide | Humming greatly increases nasal NO | Weitzberg & Lundberg 2002 |
| IBS classification | Disorder of gut-brain interaction (Rome IV) | Drossman 2016 |
| Cholinergic anti-inflammatory pathway | Vagal acetylcholine suppresses TNF-α | Tracey 2002 |

## Voice anchors (match the series)
- Second person ("you"), warm, plainspoken, never preachy. Contractions always.
...
## The 12 named core exercises (locked names)
1. The Physiological Sigh
2. Resonance Breathing (5–6 breaths/min)
...
11. Voo Breath (low vocal exhale)
12. Safe-Connection Cue (orienting / social-safety reset)

## Safety lines (must appear)
- Not a substitute for medical care; IBS needs a clinician's diagnosis.
- Cold exposure: clear with a doctor if heart condition, high blood pressure, or pregnant.
- Vagal work is an adjunct to, not a replacement for, prescribed treatment.
