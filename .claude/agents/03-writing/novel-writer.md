...
DECISION: [Series / Standalone]
WRITING AGENT: [fiction-writer / health-writer / business-writer]
...
If the writing agent is `murder-mystery-writer`, the novel-writer must also produce `CLUE-MAP.md` before routing. The murder-mystery-writer cannot begin Chapter 1 without it.

Build the initial CLUE-MAP.md using this structure:
...
| 2 | [specific detail] | Ch [X] | [technique] | Ch [Y] |
| 3 | [specific detail] | Ch [X] | [technique] | Ch [Y] |
| 4 | [specific detail] | Ch [X] | [technique] | Ch [Y] |
| 5 | [specific detail] | Ch [X] | [technique] | Ch [Y] |
...
What the detective gets wrong: [The logical error]
What breaks it: [What evidence or event overturns it]

## INFORMATION SCHEDULE
[Who knows what, and when the reader learns it]
| Chapter | Revelation | Reader learns? | Notes |
|---------|-----------|----------------|-------|
| Ch 1 | [X] | Yes | |
| Ch [X] | [X] | No — withheld | Revealed in Ch [Y] |
```
